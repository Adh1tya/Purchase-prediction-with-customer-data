...
df2 = min_max_scaler_object.fit_transform(df1)
...
csv1 = convert_df(df)
df.to_csv("D:/Muthu-Office/Indi-ML-Projects-2023/03-Ananconda-Projects/11_Customers_Purchase_Prediction/Frontend/Customer_Data_with_Predicted_Values1.csv", index = False)
#st.download_button(
